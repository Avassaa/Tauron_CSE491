...
import { AssistantChatExtrasProvider } from "~/components/assistant/assistant-chat-extras-context"
  ...
  return (
    <>
      ...
      <AssistantDockProvider>
        <AssistantChatExtrasProvider>{children}</AssistantChatExtrasProvider>
      </AssistantDockProvider>
      <Toaster />
    </>
  )
