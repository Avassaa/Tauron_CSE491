...
const mdText = "text-sm leading-relaxed text-foreground"

const components = {
  p: ({ className, ...props }: React.ComponentProps<"p">) => (
    <p className={cn("mb-2 last:mb-0", mdText, className)} {...props} />
  ),
  strong: ({ className, ...props }: React.ComponentProps<"strong">) => (
    <strong className={cn("font-semibold text-foreground", className)} {...props} />
  ),
  em: ({ className, ...props }: React.ComponentProps<"em">) => (
    <em className={cn("italic", mdText, className)} {...props} />
  ),
  u: ({ className, ...props }: React.ComponentProps<"u">) => (
    <u className={cn("underline underline-offset-2", mdText, className)} {...props} />
  ),
  ...
  ul: ({ className, ...props }: React.ComponentProps<"ul">) => (
    <ul className={cn("my-2 list-disc space-y-1 pl-5", mdText, className)} {...props} />
  ),
  ol: ({ className, ...props }: React.ComponentProps<"ol">) => (
    <ol className={cn("my-2 list-decimal space-y-1 pl-5", mdText, className)} {...props} />
  ),
  ...
  h1: ({ className, ...props }: React.ComponentProps<"h1">) => (
    <h1 className={cn("mb-1 mt-3 text-base font-semibold first:mt-0", mdText, className)} {...props} />
  ),
  h2: ({ className, ...props }: React.ComponentProps<"h2">) => (
    <h2 className={cn("mb-1 mt-2 text-sm font-semibold first:mt-0", mdText, className)} {...props} />
  ),
  h3: ({ className, ...props }: React.ComponentProps<"h3">) => (
    <h3 className={cn("mb-1 mt-2 text-sm font-semibold first:mt-0", mdText, className)} {...props} />
  ),
  del: ({ className, ...props }: React.ComponentProps<"del">) => (
    <del className={cn("line-through opacity-90", mdText, className)} {...props} />
  ),
