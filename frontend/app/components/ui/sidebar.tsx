    ...
    return (
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        <SheetContent
          ...
          data-slot="sidebar"
          data-mobile="true"
          className="w-(--sidebar-width) border-border/50 bg-white/85 p-0 text-sidebar-foreground backdrop-blur-xl dark:bg-sidebar [&>button]:hidden"
          style={
            {
  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={cn(
          "fixed top-[var(--market-banner-offset,0px)] bottom-0 z-10 hidden h-[calc(100svh-var(--market-banner-offset,0px))] w-(--sidebar-width) transition-[left,right,width,height,top] duration-200 ease-linear md:flex",
          side === "left"
...
function SidebarInset({ className, ...props }: React.ComponentProps<"main">) {
  return (
    <main
      ...
      className={cn(
        "glass-page-bg relative flex w-full min-w-0 flex-1 flex-col overflow-x-clip",
